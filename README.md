...
price-alert rules and live grid-trading bots (⚠️ real orders, off by
default, its own two-factor arming plus a dedicated safety design) you
add/edit/remove entirely from its Settings page (HA 2025.3.0+); order
